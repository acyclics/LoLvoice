...
# Cancel sentence
Sometimes when you started speaking you might want to cancel the sentence being typed. You can do this by pressing the keybind assigned to "cancel sentence" in the settings. Note the "cancel sentence" keybind must be pressed while the "push-to-talk" keybind is held for the sentence to cancel. Therefore, I would recommend you to assign the keybind for "cancel sentence" to the key next to your keybind for "talking" (ex. if your keybind for "talking" is "x", then assign "z" as the keybind for "cancel sentence"). This means when you're holding "x" to talk and suddenly want to cancel your sentence, you can simply slide your finger to "z".
